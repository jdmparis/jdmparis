...
* 🔨 **I build AI agents and micro tools to make my life run better.** Some are public, others not (yet):
  ...
  * **Rachel**: my intelligence analyst. She listens to the investor calls nobody has time for, 50+ retail, consumer, and luxury companies, and distills what the C-suite is really talking about. Her job: keep me the most knowledgeable person in the room on AI in retail, consumer, and luxury.
  * **Cody**: I'm not a computer scientist, so I built my own engineer. He pressure-tests everything I ship: security, IP, quality.
  * **Josh**: helps my family and me navigate moves across countries and the long game of my career.

* 🕸️ **These aren't four agents. They're four swarms.** Each one orchestrates its own subagents, they share memory, and they coordinate through a sprint board where they leave each other notes. Built with Claude Code and custom MCP servers. The apps live on Vercel and Cloudflare, the data in Supabase and Upstash, and the shared brain in Obsidian. It's the same orchestration problem every enterprise is about to face, in miniature.
...
* 🧒 **My favourite beta testers are teenagers: my own sons, both born in the 2010s.** They test my agents, question everything, and force me to rephrase until it's simple, fun, and human. Best design reviewers I've ever worked with. (For the grown-ups: I also advise AI startups backed by leading VCs across the globe.)
...
*This is my personal corner of GitHub. Everything here is built on my own time, with my own tools, for my own life. None of it is affiliated with, or represents the views of, my employer.*
